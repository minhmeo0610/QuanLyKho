...
namespace QuanLyKho {
    ...
    public partial class QuanLyKho : global::System.Data.DataSet {
        ...
        public partial class InHoaDonDataTable : global::System.Data.TypedTableBase<InHoaDonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public InHoaDonRow AddInHoaDonRow(string MaSP, int SoLuong, string MaHD, int DonGia, string TenDoiTac, string DiaChi, string SoDT, string TenLoaiSP, System.DateTime NgayLap, string TenSP, int Gia, string TenNV, int ThanhTien) {
        ...
        public partial class SanPhamDataTable : global::System.Data.TypedTableBase<SanPhamRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public SanPhamRow AddSanPhamRow(string MaSP, string TenSP, string MaLoaiSP, int Gia, string GhiChu, System.DateTime NSX) {
...
namespace QuanLyKho.QuanLyKhoTableAdapters {
    ...
    public partial class InHoaDonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        ChiTietHoaDon.MaSP, ChiTietHoaDon.SoLuong, ChiTietHoaDon.MaHD, ChiTietHoaDon.DonGia, DoiTac.TenDoiTac, DoiTac.DiaChi, DoiTac.SoDT, LoaiSanPham.TenLoaiSP, HoaDon.NgayLap, SanPham.TenSP, SanPham.Gia, 
                         NhanVien.TenNV, ChiTietHoaDon.SoLuong * SanPham.Gia AS ThanhTien
FROM            ChiTietHoaDon INNER JOIN
        ...
        public virtual int Fill(QuanLyKho.InHoaDonDataTable dataTable) {
        ...
        public virtual QuanLyKho.InHoaDonDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QuanLyKho.InHoaDonDataTable dataTable = new QuanLyKho.InHoaDonDataTable();
    ...
    public partial class SanPhamTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [SanPham] WHERE (([MaSP] = @Original_MaSP) AND ((@IsNull_TenSP = 1 AND [TenSP] IS NULL) OR ([TenSP] = @Original_TenSP)) AND ((@IsNull_MaLoaiSP = 1 AND [MaLoaiSP] IS NULL) OR ([MaLoaiSP] = @Original_MaLoaiSP)) AND ((@IsNull_Gia = 1 AND [Gia] IS NULL) OR ([Gia] = @Original_Gia)) AND ((@IsNull_NSX = 1 AND [NSX] IS NULL) OR ([NSX] = @Original_NSX)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [SanPham] ([MaSP], [TenSP], [MaLoaiSP], [Gia], [GhiChu], [NSX]) VALUE" +
                "S (@MaSP, @TenSP, @MaLoaiSP, @Gia, @GhiChu, @NSX);\r\nSELECT MaSP, TenSP, MaLoaiSP" +
                ", Gia, GhiChu, NSX FROM SanPham WHERE (MaSP = @MaSP)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [SanPham] SET [MaSP] = @MaSP, [TenSP] = @TenSP, [MaLoaiSP] = @MaLoaiSP, [Gia] = @Gia, [GhiChu] = @GhiChu, [NSX] = @NSX WHERE (([MaSP] = @Original_MaSP) AND ((@IsNull_TenSP = 1 AND [TenSP] IS NULL) OR ([TenSP] = @Original_TenSP)) AND ((@IsNull_MaLoaiSP = 1 AND [MaLoaiSP] IS NULL) OR ([MaLoaiSP] = @Original_MaLoaiSP)) AND ((@IsNull_Gia = 1 AND [Gia] IS NULL) OR ([Gia] = @Original_Gia)) AND ((@IsNull_NSX = 1 AND [NSX] IS NULL) OR ([NSX] = @Original_NSX)));
SELECT MaSP, TenSP, MaLoaiSP, Gia, GhiChu, NSX FROM SanPham WHERE (MaSP = @MaSP)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT        MaSP, TenSP, MaLoaiSP, Gia, GhiChu, NSX\r\nFROM            SanPham";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(QuanLyKho.SanPhamDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual QuanLyKho.SanPhamDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QuanLyKho.SanPhamDataTable dataTable = new QuanLyKho.SanPhamDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QuanLyKho.SanPhamDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QuanLyKho dataSet) {
        ...
        public virtual int Delete(string Original_MaSP, string Original_TenSP, string Original_MaLoaiSP, global::System.Nullable<int> Original_Gia, global::System.Nullable<global::System.DateTime> Original_NSX) {
        ...
        public virtual int Insert(string MaSP, string TenSP, string MaLoaiSP, global::System.Nullable<int> Gia, string GhiChu, global::System.Nullable<global::System.DateTime> NSX) {
            if ((MaSP == null)) {
            ...
            if ((NSX.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[5].Value = ((System.DateTime)(NSX.Value));
            }
            else {
        ...
        public virtual int Update(string MaSP, string TenSP, string MaLoaiSP, global::System.Nullable<int> Gia, string GhiChu, global::System.Nullable<global::System.DateTime> NSX, string Original_MaSP, string Original_TenSP, string Original_MaLoaiSP, global::System.Nullable<int> Original_Gia, global::System.Nullable<global::System.DateTime> Original_NSX) {
            if ((MaSP == null)) {
                throw new global::System.ArgumentNullException("MaSP");
            }
            else {
            ...
            if ((NSX.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((System.DateTime)(NSX.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TenSP, string MaLoaiSP, global::System.Nullable<int> Gia, string GhiChu, global::System.Nullable<global::System.DateTime> NSX, string Original_MaSP, string Original_TenSP, string Original_MaLoaiSP, global::System.Nullable<int> Original_Gia, global::System.Nullable<global::System.DateTime> Original_NSX) {
            return this.Update(Original_MaSP, TenSP, MaLoaiSP, Gia, GhiChu, NSX, Original_MaSP, Original_TenSP, Original_MaLoaiSP, Original_Gia, Original_NSX);
        }
    }
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateUpdatedRows(QuanLyKho dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._sanPhamTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateInsertedRows(QuanLyKho dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._sanPhamTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        private int UpdateDeletedRows(QuanLyKho dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._sanPhamTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        public virtual int UpdateAll(QuanLyKho dataSet) {
            if ((dataSet == null)) {
